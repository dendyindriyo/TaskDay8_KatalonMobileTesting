...
Mobile.setText(findTestObject('Object Repository/Android/android.widget.EditText - Card - Card Number'), 'asd', 1)

WebUI.delay(3)

Mobile.setText(findTestObject('Object Repository/Android/android.widget.EditText - Card - Expiration Date'), '0/2', 0)

Mobile.setText(findTestObject('Object Repository/Android/android.widget.EditText - Card - Security Code'), '12', 0)

WebUI.delay(3)

Mobile.takeScreenshot('D:\\Program Files\\Katalon\\Katalon Projects\\TaskDay8_KatalonMobileTesting_DendyIndriyoSaputro\\Screenshot\\screenshot4.png')
